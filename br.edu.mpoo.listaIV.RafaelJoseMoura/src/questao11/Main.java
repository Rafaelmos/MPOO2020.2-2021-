...
public class Main {
	...
	public static void main(String[] args) {
		...
		Cliente cliente = new Cliente("Robertinho","155.115.154-45");
		...
		//cliente.pedirDesconto(false);
		
		caixa.registrarCompra(produto, vendedor, gerenteVendas, false, false);
		caixa.registrarCompra(produto1, vendedor, gerenteVendas, false, false);
